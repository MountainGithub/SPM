...
# Name, Date Created , Modify Date, Size
        projects_data = [
            ['Game #1','2/8/2024',3.8],
            ['Game #2','1/1/2024',4.2],
            ['Gamehhhhhhhhhhhh #3','4/3/2023',2.3],
            ['Game #4','4/3/2023',2.3],
            ['Game #5','4/3/2023',2.3],
            ['Game #6','4/3/2023',2.3],
            ['Game #7','4/3/2023',2.3],
            ['Game #8','4/3/2023',2.3],
            ['Gamuuuuuuuuuue #9','4/3/2023',2.3],
            ['Game #10','4/3/2023',2.3],
            ['Game #11','4/3/2023',2.3],
            ['Game #12','4/3/2023',2.3],
            ['Game #13','4/3/2023',2.3],
        ]
        ...
        ttk.CTkLabel(lable_frame_1, text_color=self.asset.red,text='69 files found.').pack(side='left',padx=25)
        ...
        target_frame = sbf.scrolled_frame

        project_row = -1
        for name, date, size in projects_data:
            project_row+=1
            self.create_item(target_frame, name, date, size, project_row).grid(column=0,row=project_row)
        ...
        reveal.bind("<Button-1>", lambda e: subprocess.Popen(r'explorer /select,"C:\"'))
    ...
    def choose_workspace(self):
        WORKSPACE = ttk.filedialog.askdirectory()
    ...
    def create_item(self, master, name:str, date:str, size:float, style):
        ...
        ttk.CTkButton(frame,fg_color=self.asset.lighter_black,text_color_disabled='#e2e6e9',state='disabled',corner_radius=0,text = f"{size}MB").grid(row = 0, column = 4,sticky='nsew')
